...
function createLottoBalls()
{
    ...
    {
        $('#ballcontainer').append("<span class='lottoball'> <input id='lb_nr_" + i + "' class='lottoball' type='number' min='1' max='50' placeholder='_' onchange='checkLottoBall(" + i + ");' aria-required='true' required> </span>");
    }
}
